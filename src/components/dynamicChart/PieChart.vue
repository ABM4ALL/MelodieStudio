...
import { createLinechartDefaultData, createPieChartDefaultData } from "./defaultoptions";
...
export default defineComponent({
    ...
    data() {
        const defaultOptions = createPieChartDefaultData() as echarts.EChartsOption;
        return {
            selectionItems: {} as any,
            unchangeableItems: {} as any,
            chartDOMID: nanoid(),
            currentStep: 0,
            simulationData: { series: [{ data: [] }] },
        ...
        getChartInitialOptions(this.chartName).then(
            (resp: echarts.EChartsCoreOption | null) => {
                ...
                if (resp !== null) {
                    ...
                    this.chartOption = chartNewOption as echarts.EChartsOption;
                }
                ...
                //         newSeries.data!.push([i + 1, singleSeries.data[i]]);
                //     }
    ...
    methods: {
        ...
        async onOptionDelete(): Promise<void> {
            ...
            this.chartOption = defaultOptions.genericOption as echarts.EChartsOption;
            this.$chart.setOption(this.chartOption);
